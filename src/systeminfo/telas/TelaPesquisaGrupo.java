 ...
 * @author Nutrizon
 */
public class TelaPesquisaGrupo extends javax.swing.JInternalFrame {
    ...
    private void pesquisa() {
        String sql = "select idgru as Codigo, gruDescricao as Grupo from tbGrupos where gruDescricao like ?";
        try {
...
// metodo para setar os campos dos formularios com o conteudo da tabela
    ...
    public void setar_campos() {
        ...
        //TelaCadastroProdutos.txtCadProdGrupo.setText(tblPesqResult.getModel().getValueAt(setar, 0).toString());
        String sql1 = "select idgru as Codigo, gruDescricao as Descrição from tbGrupos where idgru = ?";
        try {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Pesquisa de Grupo");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Digite o Grupo:"));
    ...
    private void btnPesqCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesqCancelarActionPerformed
        // cancelar a tela
       // TelaCadastroProdutos.txtCadProdGrupo.setText(null);
        dispose();
