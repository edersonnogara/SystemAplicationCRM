 ...
 * @author Nutrizon
 */
public class TelaPesqAtivosEscravoEnlace extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqAtivosEscravoEnlace() {
        initComponents();
...
// metodo para setar os campos dos formularios com o conteudo da tabela
    ...
    public void setar_campos() {
        ...
        TelaCadEnlaces.txtCadEnlaceIdEscravo.setText(tblPesqResult.getModel().getValueAt(setar, 0).toString());
...
//        TelaCadAtivos.cboCadAtivoStatus.setText(tblPesqResult.getModel().getValueAt(setar, 9).toString());
        TelaCadEnlaces.txtCadEnlaceEscravo.setText(tblPesqResult.getModel().getValueAt(setar, 10).toString());
