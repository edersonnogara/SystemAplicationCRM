 ...
 * @author Nutrizon
 */
public class TelaPesquisaTorre extends javax.swing.JInternalFrame {
    ...
    private void pesquisa() {
        String sql = "select idTorres as Codigo, TorresDescricao as Descrição from tbTorres where TorresDescricao like ?";
        try {
...
// metodo para setar os campos dos formularios com o conteudo da tabela
    ...
    public void setar_campos() {
        ...
        TelaCadProdutos.txtCadProdTorre.setText(tblPesqResult.getModel().getValueAt(setar, 1).toString());
        
        String sql1 = "select idTorres as Codigo, TorresDescricao as Descrição from tbTorres where idTorres = ?";
        try {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Pesquisa de Torre");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Digite a Torre:"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(txtPesqCidCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void btnPesqConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesqConfirmarActionPerformed
        ...
        if (txtPesqCidCodigo.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Selecione uma Torre!");
        } else {
            dispose();
        }
