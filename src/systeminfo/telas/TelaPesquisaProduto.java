...
public class TelaPesquisaProduto extends javax.swing.JInternalFrame {
    ...
    private void pesquisa() {
        String sql = "select idprod as Codigo, prodDescricao as Descrição, prodVendaAvista as Valor from tbprodutos where prodDescricao like ?";
        try {
...
// metodo para setar os campos dos formularios com o conteudo da tabela
    ...
    public void setar_campos() {
        ...
        txtPesqCidade.setText((String) tblPesqResult.getModel().getValueAt(setar, 1));
        txtPesqCidValor.setText(tblPesqResult.getModel().getValueAt(setar, 2).toString());
        //manipula os objetos da tela de cadastro de cidade que foram declarados publicos
        TelaLancFichaExameMedico.txtExaDescServico.setText(tblPesqResult.getModel().getValueAt(setar, 1).toString());
        TelaLancFichaExameMedico.txtExaCodServ.setText(tblPesqResult.getModel().getValueAt(setar, 0).toString());
        TelaLancFichaExameMedico.txtExaValor.setText(tblPesqResult.getModel().getValueAt(setar, 2).toString());
        
        String sql1 = "select idprod as Codigo, prodDescricao as Descrição, prodVendaAvista as Valor from tbprodutos where idprod = ?";
        try {
    ...
    private void initComponents() {
        ...
        txtPesqCidValor = new javax.swing.JTextField();
        ...
        setTitle("Pesquisa de Produdos/Serviços");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Digite o Nome do Produto/Serviço:"));
        ...
        txtPesqCidValor.setEditable(false);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtPesqCidValor, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addComponent(jLabel1)
                .addComponent(jLabel2)
                .addComponent(txtPesqCidValor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        if (tblPesqResult.getColumnModel().getColumnCount() > 0) {
            ...
            tblPesqResult.getColumnModel().getColumn(1).setPreferredWidth(400);
            tblPesqResult.getColumnModel().getColumn(2).setResizable(false);
            tblPesqResult.getColumnModel().getColumn(2).setPreferredWidth(50);
        }
    ...
    private void btnPesqConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesqConfirmarActionPerformed
        ...
        if (txtPesqCidCodigo.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Selecione um Produto/Serviço!");
        } else {
            dispose();
        }
    ...
    private void btnPesqCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesqCancelarActionPerformed
        // cancelar a tela
        TelaLancFichaExameMedico.txtExaDescServico.setText(null);
        TelaLancFichaExameMedico.txtExaCodServ.setText(null);
        //TelaCadastroProdutos.txtCadProdAvista.setText(null);
    ...
    private javax.swing.JTextField txtPesqCidValor;
