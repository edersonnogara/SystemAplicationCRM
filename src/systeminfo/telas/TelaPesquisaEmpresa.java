 ...
 * @author Nutrizon
 */
public class TelaPesquisaEmpresa extends javax.swing.JInternalFrame {
    ...
    private static TelaPesquisaEmpresa telaCad;

    public static TelaPesquisaEmpresa getInstancia() {
        if (telaCad == null) {
            telaCad = new TelaPesquisaEmpresa();
        }
        return telaCad;
    }
...
// metodo para setar os campos dos formularios com o conteudo da tabela
    ...
    public void setar_campos() {
        ...
        TelaCadClientes.txtCadPesCodigo.setText(tblPesqResult.getModel().getValueAt(setar, 0).toString());
        TelaCadClientes.txtCadPesNome.setText(tblPesqResult.getModel().getValueAt(setar, 1).toString());
        TelaCadClientes.txtCadPesFantasia.setText(tblPesqResult.getModel().getValueAt(setar, 2).toString());
        TelaCadClientes.txtCadPesCNPJ.setText(tblPesqResult.getModel().getValueAt(setar, 3).toString());
        ...
        TelaCadClientes.txtCadPesTelefone.setText(tblPesqResult.getModel().getValueAt(setar, 6).toString());
        ...
        String sql = "select * from tbEmpresa where idPes = ? ";
        try {
...
//chekbox ativo ou inativo
            ...
            TelaCadClientes.txtCadPesIE.setText(rs1.getString(7));
            TelaCadClientes.txtCadPesEmail.setText(rs1.getString(9));
            TelaCadClientes.txtCadPesEndComp.setText(rs1.getString(14));
            TelaCadClientes.idcidade.setText(rs1.getString(15));
            TelaCadClientes.txtCadPesBairro.setText(rs1.getString(16));
            //TelaCadastroPessoas.txtCadPesNaturalidade.setText(rs1.getString(19));
            TelaCadClientes.txtCadPesObservacao.setText(rs1.getString(17));
            tblPesqResult.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
