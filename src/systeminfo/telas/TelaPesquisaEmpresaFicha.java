 ...
 * @author Nutrizon
 */
public class TelaPesquisaEmpresaFicha extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaEmpresaFicha() {
        initComponents();
    ...
    private void pesquisa() {
        String sql = "select p.idpes as Codigo, p.pesNome as Nome, p.pesFantasia as Fantasia, p.pesCPF_CNPJ as 'CPF/CNPJ', p.pesEndereco as Endereço, p.pesEndNum as Numero, p.pesTelefone as Telefone, p.pesCelular as Celular, c.cidNome as Cidade, p.idcidade as cod_Cidade from tbempresa p \n" +
...
// metodo para setar os campos dos formularios com o conteudo da tabela
    ...
    public void setar_campos() {
        ...
        TelaLancFichaExameMedico.txtExaCodEmpresa.setText(tblPesqResult.getModel().getValueAt(setar, 0).toString());
        TelaLancFichaExameMedico.txtExaDescEmpresa.setText(tblPesqResult.getModel().getValueAt(setar, 1).toString());
        //TelaCadastroPessoas.txtCadPesCodigo.setText(tblPesqResult.getModel().getValueAt(setar, 0).toString());
//        TelaCadastroPessoas.txtCadPesNome.setText(tblPesqResult.getModel().getValueAt(setar, 1).toString());
//        TelaCadastroPessoas.txtCadPesFantasia.setText(tblPesqResult.getModel().getValueAt(setar, 2).toString());
//        TelaCadastroPessoas.txtCadPesCNPJ.setText(tblPesqResult.getModel().getValueAt(setar, 3).toString());
//        TelaCadastroPessoas.txtCadPesEndereco.setText(tblPesqResult.getModel().getValueAt(setar, 4).toString());
//        TelaCadastroPessoas.txtCadPesNumEndereco.setText(tblPesqResult.getModel().getValueAt(setar, 5).toString());
//        TelaCadastroPessoas.txtCadPesTelefone.setText(tblPesqResult.getModel().getValueAt(setar, 6).toString());
//        TelaCadastroPessoas.txtCadPesCelular.setText(tblPesqResult.getModel().getValueAt(setar, 7).toString());
//        TelaCadastroPessoas.txtCadPesCidade.setText(tblPesqResult.getModel().getValueAt(setar, 8).toString());
//        TelaCadastroPessoas.idcidade.setText(tblPesqResult.getModel().getValueAt(setar, 9).toString());
        String sql = "select * from tbEmpresa where pesAtivo = 'A' and idPes = ? ";
        try {
...
//            tblPesqResult.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Digite a Empresa:"));
