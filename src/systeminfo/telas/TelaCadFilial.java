 ...
 * @author Nogara
 */
public class TelaCadFilial extends javax.swing.JInternalFrame {
    ...
    private static TelaCadFilial telaCad;

    public static TelaCadFilial getInstancia() {
        if (telaCad == null) {
            telaCad = new TelaCadFilial();
        }
        return telaCad;
    }
