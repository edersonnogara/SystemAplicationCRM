 ...
 * @author Nutrizon
 */
public class TelaPesquisaAlmox extends javax.swing.JInternalFrame {
    ...
    private void pesquisa() {
        String sql = "select idAlmox as Codigo, AlmoxDescricao as Descrição from tbAlmox where AlmoxDescricao like ?";
        try {
...
// metodo para setar os campos dos formularios com o conteudo da tabela
    ...
    public void setar_campos() {
        ...
        TelaCadProdutos.txtCadProdAlmox.setText(tblPesqResult.getModel().getValueAt(setar, 1).toString());
        
        String sql1 = "select idAlmox as Codigo, AlmoxDescricao as Descrição from tbAlmox where idAlmox = ?";
        try {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Pesquisa de Almoxarifado");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Digite o Almoxarifado:"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addComponent(txtPesqCidade, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtPesqCidCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void btnPesqConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesqConfirmarActionPerformed
        ...
        if (txtPesqCidCodigo.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Selecione um Almoxarifado!");
        } else {
            dispose();
        }
    ...
    private void btnPesqCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesqCancelarActionPerformed
        // cancelar a tela
        TelaCadProdutos.txtCadProdMarca.setText(null);
        dispose();
