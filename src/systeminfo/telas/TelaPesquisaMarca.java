 ...
 * @author Nutrizon
 */
public class TelaPesquisaMarca extends javax.swing.JInternalFrame {
    ...
    private void pesquisa() {
        String sql = "select idMarca as Codigo, MarcaDescricao as Descrição from tbMarcas where MarcaDescricao like ?";
        try {
...
// metodo para setar os campos dos formularios com o conteudo da tabela
    ...
    public void setar_campos() {
        ...
        TelaCadProdutos.txtCadProdMarca.setText(tblPesqResult.getModel().getValueAt(setar, 1).toString());
        
        String sql1 = "select idMarca as Codigo, MarcaDescricao as Descrição from tbMarcas where idMarca = ?";
        try {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Digite a Marca:"));
